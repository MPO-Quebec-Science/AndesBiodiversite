...
testthat::test_that("obis_datetime_str works correctly, no explicit timezone", {
    ...
    testthat::expect_equal(obis_datetime_str(dt, 7), "2024-06-01T13:14:15.150000+0000")
})
...
testthat::test_that("obis_datetime_str works correctly, explicit timezone", {
    ...
    testthat::expect_equal(obis_datetime_str(dt, 7), "2024-06-01T13:14:15.150000-0500")
})
...
testthat::test_that("obis_datetime_str works correctly, explicit timezone", {
    ...
    testthat::expect_equal(obis_datetime_str(dt, 7, tz = "EST"), "2024-06-01T13:14:15.150000-0500")
})
