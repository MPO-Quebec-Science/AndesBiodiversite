...
testthat::test_that("obis_datetime_str works correctly, no explicit timezone", {
    ...
    dt <- lubridate::ymd_hms("2024-06-01 13:14:15.16")
    ...
    testthat::expect_equal(obis_datetime_str(dt, 7), "2024-06-01T13:14:15.160000+0000")
})

testthat::test_that("obis_datetime_str works correctly, no explicit timezone", {
    # this is by default in UTC
    dt <- lubridate::ymd_hms("2024-06-01 13:14:15.16", tz = "EST")
    testthat::expect_equal(obis_datetime_str(dt, 1), "2024")
    testthat::expect_equal(obis_datetime_str(dt, 2), "2024-06")
    testthat::expect_equal(obis_datetime_str(dt, 3), "2024-06-01")
    ...
    testthat::expect_equal(obis_datetime_str(dt, 7), "2024-06-01T13:14:15.160000-0500")
})
...
testthat::test_that("obis_datetime_str works correctly, no explicit timezone", {
    ...
    testthat::expect_equal(obis_datetime_str(dt, 4, tz = "EST"), "2024-06-01T13-0500")
    testthat::expect_equal(obis_datetime_str(dt, 5, tz = "EST"), "2024-06-01T13:14-0500")
    testthat::expect_equal(obis_datetime_str(dt, 6, tz = "EST"), "2024-06-01T13:14:15-0500")
    testthat::expect_equal(obis_datetime_str(dt, 7, tz = "EST"), "2024-06-01T13:14:15.160000-0500")
})
