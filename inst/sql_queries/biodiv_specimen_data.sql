SELECT 
	...
	shared_models_basket.size_class AS BASKET_CLASS,
    mix_parent_refcatch.is_mixed_catch AS from_mixed_catch, -- will need to convert to FRACTION_DENOMINATOR (4 or 1)
    shared_models_basket.sampled AS BASKET_SAMPLED,
    SUM( (CASE WHEN (shared_models_basket.sampled=1) THEN 1 ELSE 0 END)) AS MEASURED_SPECIMEN_COUNT,
