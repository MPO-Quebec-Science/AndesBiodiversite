...
`FINAL_COUNT` : ($N_\mathrm{final}$) Résultat d'un calcul. Représente le dénombrement et le poids ramené à la capture totale. (calcul= SORTED*MULTIPLICATEUR).

`FINAL_MASS` : ($M_\mathrm{final}$)Résultat d'un calcul. Représente le poids ramené à la capture totale. (calcul= SORTED*MULTIPLICATEUR)
